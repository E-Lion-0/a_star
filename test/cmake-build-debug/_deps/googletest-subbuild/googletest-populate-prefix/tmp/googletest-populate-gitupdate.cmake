...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v1.14.x"
  WORKING_DIRECTORY "/Users/elionkaraboja/CLionProjects/a_star/test/cmake-build-debug/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/elionkaraboja/CLionProjects/a_star/test/cmake-build-debug/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/elionkaraboja/CLionProjects/a_star/test/cmake-build-debug/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
